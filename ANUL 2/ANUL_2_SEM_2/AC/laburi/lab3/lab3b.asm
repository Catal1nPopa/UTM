...
.code ; segmentul de cod
	...
	mov edx,offset mes2
	call WriteString;
	mov eax, 10 ; setam valoarea minima
	mov ebx, 15 ; setarea valoarea maxima
	call RandomRange 
	sub eax, 5;
	mov vry, eax ; setam valoarea random
	call WriteInt
	call Crlf
...
impar:
    ...
    add eax, ebx    ; rezultatul adunaii valorii din ebx cu eax
