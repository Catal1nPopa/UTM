-- Inserare de exemple de date în tabela "discipline"
INSERT INTO univer.discipline (Id_Disciplina, Disciplina, Nr_ore_plan_disciplina)
VALUES
	...
	(119, 'Integrare informationala europeana', 20),
